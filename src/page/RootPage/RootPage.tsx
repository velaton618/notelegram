                            ...
                            child: <div className={s.SliderSegmentWIIContainer}>
                                ...
                                <div className={s.WIIContent}>
                                    <p className={s.P1} style={{
                                        ...
                                        <div className="input_outline"><input className="input" onChange={(e) => setPhone(e.target.value)} placeholder="Enter Phone Number" /></div>
                                    </p>
                                ...
                                <div className={s.SliderSegmentWAPContent}>
                                    ...
                                    <div className={s.SliderSegmentS2} style={{
                                        ...
                                        <div className={s.S2Content}>
                                            <div className="input_outline"><input className="input" onChange={(e) => setCode(e.target.value)} placeholder="Enter Verification Code" /></div>
                                        </div>
